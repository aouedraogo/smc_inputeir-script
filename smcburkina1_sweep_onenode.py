...
#expname = 'newsmcexp07_50yr-inputeir-burnin_smcSPA_0R_Sweep-HS.33'

#expname = 'newsmcexp02_5yr_burnin_SPA_.KillRate_100SPIC50_1000AQIC50_CampStartDay230_3R_Sweep'
...
expname = 'test_clinical_case_incidence_inputeir_COV.75_RATE.0'
#expname = '50yr-serial_burkina_site_EIR_03'
#expname = 'Example SMC_Template'
...
cb.update_params( {"Geography": "Burkina",
                   ...
                   "Serialized_Population_Path": "//Idmppfil01/idm/home/aouedraogo/output/50yr-serial_burkina_site_EIR_03_2017_07_03_09_57_58_972000/595/a3e/e31/595a3ee3-1060-e711-9401-f0921c16849d/output/",                                                
...
add_health_seeking(cb, start_day=0, drug=['Lumefantrine', 'Artemether'],
                   targets=[{'trigger': 'NewClinicalCase', 'coverage': .75, 'agemin': 0, 'agemax': 5, 'seek': 1,
                             'rate': 0.0}, {'trigger': 'NewClinicalCase', 'coverage': .33, 'agemin': 5, 'agemax': 200, 'seek': 1,
                             'rate': 0.0}])
